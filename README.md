...
│
├── 📁 notebooks/
│   └── BoomBikesPrediction.ipynb        Full EDA + modelling notebook
│
├── 📁 outputs/
│   ├── modelsummary.txt                 OLS regression summary
...
seasonwinter  High  ➕ Positive 
weathersitLight Snow/Rain  High  ➖ Negative 
windspeed  Moderate  ➖ Negative 
seasonspring  Moderate  ➖ Negative 
mnthSep  Moderate  ➕ Positive 
...
bash
jupyter notebook notebooks/BoomBikesPrediction.ipynb
...
- UCI Machine Learning Repository
 — Original Bike Sharing Dataset
- Kaggle — BoomBikes Case Study
